...
<body>
    <nav class="navbar navbar-expand-sm navbar-light bg-light fixed-top">
        <div class="container ml-5">
            <!-- Left side: Logo -->
            <a class="navbar-brand" href="adminloginhome.php">
...
?>
    <h3 class="my-3" style="text-decoration:underline;">New registerd users:</h3>
...
while ($row = mysqli_fetch_assoc($result)) {
    if($row['role'] != 'admin' && $row['auth'] == 0){
        ...
        ';
        if($row['auth'] == 1){
          echo'  <button class="btn btn-success ">Active</button></a>
